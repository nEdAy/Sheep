...
//import cn.neday.sheep.adapter.PhotoListAdapter
...
//    PhotoListFragment<SearchResultViewModel>(R.layout.fragment_goods_list) {
//
...
//    }
//
//    private fun setAdapterData(adapter: PhotoListAdapter, data: Pages<CommonGoods>) {
